...
export function FormAddImage({ closeModal }: FormAddImageProps): JSX.Element {
  ...
  const onSubmit = async (formData: FormParams): Promise<void> => {
    try {
      if (!imageUrl) {
        toast({
          title: 'Adicionar uma imagem é obrigatório',
          description:
            'É obrigatório adicionar uma imagem para finalizar o cadastro',
          status: 'error',
          isClosable: true,
        });
      }
